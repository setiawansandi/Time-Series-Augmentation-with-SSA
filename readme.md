...
- ### Setting up
  ...
  | pltSSsur.py         | Similar to above but running this script allows you to swiftly enter the file names and plot the surrogate output. To run this script simply type in terminal:<br/>`python -m pltSSsur`                                                                                                                            |
